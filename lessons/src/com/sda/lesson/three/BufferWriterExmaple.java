...
public class BufferWriterExmaple {
    ...
    public static void main(String[] args) {
        try{
            ...
            BufferedWriter out = new BufferedWriter(new FileWriter("informacioniKryesor.txt"));
            out.write(maxLength);
            out.newLine();
            out.write(max);
            out.newLine();
            ...
            out.close();
            FileOutputStream  outputStream = new FileOutputStream("informacioniKryesor1.txt");
